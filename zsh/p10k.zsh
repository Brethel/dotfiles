# Generated by Powerlevel10k configuration wizard on 2020-09-29 at 08:40 -03.
...
() {
  ...
  function prompt_showFreeDisk() {
    p10k segment -f 208 -t "$(df -h . | tail -1 | awk '{print $4}') free"
  }
